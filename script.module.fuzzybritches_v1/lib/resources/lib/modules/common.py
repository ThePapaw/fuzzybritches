...
AddonTitle     = "[COLOR yellow]Fuzzy Britches v1[/COLOR]"
...
def TextBoxes(announce):
    class TextBox():
        ...
        def setControls(self):
            self.win.getControl(self.CONTROL_LABEL).setLabel('Fuzzy Britches') # set heading
...
def GET_M3U_LIST(url):
    ...
    for channel in sorted(m3u_list):
        ...
        addLink('[COLOR orange]'+name.title()+'[/COLOR]',url,996,icon,fanart)

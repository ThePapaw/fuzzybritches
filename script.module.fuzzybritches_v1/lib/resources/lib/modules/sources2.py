...
#TC 2/01/19 started
        ...
        if control.addonInfo('id') == 'plugin.video.fuzzybritches_v1':
            try:
                ...
                if quality == 'AUTO':
                    ...
                    control.window.clearProperty("plugin.video.fuzzybritches_v1.container.items")
                    control.window.setProperty("plugin.video.fuzzybritches_v1.container.items", json.dumps(items))

                    control.window.clearProperty("plugin.video.fuzzybritches_v1.container.meta")
                    control.window.setProperty("plugin.video.fuzzybritches_v1.container.meta", meta)
                    control.window.clearProperty(self.itemProperty)
                    control.window.setProperty(self.itemProperty, json.dumps(items))
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.fuzzybritches_v1.container.items'

        self.metaProperty = 'plugin.video.fuzzybritches_v1.container.meta'

...
class navigator:
    ...
    NEWSFILE = base64.b64decode(b'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1RoZVBhcGF3L3htbC9tYXN0ZXIvYWRkb25fbmV3cy9mdXp6eWJyaXRjaGVzX3YxL3doYXRzbmV3LnR4dA==')
    ...
    def root(self):
        ...
        if self.getMenuEnabled('navi.iptv') == True:
            self.addDirectoryItem(
                90007, 'iptv', 'iptv.png', 'DefaultMovies.png')
        adult = True if control.setting('adult_pw') == 'lol' else False
        if adult == True:
            self.addDirectoryItem(
                90008, 'porn', 'adult.png', 'DefaultMovies.png')
    ...
    def news(self):
        ...
        if len(message) > 1:
            if compfile == message:
                ...
                text_file.close()
                compfile = message
        self.showText('Fuzzy Britches v1', compfile)
...
#######################################################################
    ...
    def movies(self, lite=False):
        ...
        if self.getMenuEnabled('navi.slim') == False:
            if self.getMenuEnabled('navi.imdblist') == True:
                self.addDirectoryItem(
                    90141, 'imdblist', 'imdb.png', 'DefaultMovies.png')
        if self.getMenuEnabled('navi.slim') == False:
    ...
    def tools(self):
        ...
        self.addDirectoryItem(32556, 'libraryNavigator',
                              'library.png', 'DefaultAddonProgram.png')
    ...
    def library(self):
        ...
        self.addDirectoryItem(32559, control.setting(
            'library.movie'), 'library_movies.png', 'DefaultMovies.png', isAction=False)
        self.addDirectoryItem(32560, control.setting(
            'library.tv'), 'library_tvshows.png', 'DefaultTVShows.png', isAction=False)
    ...
    def iptv_fluxus(self):
        ...
        if adult == True:
            self.addDirectoryItem(
                90171, 'lust', 'adult.png', 'DefaultMovies.png')
